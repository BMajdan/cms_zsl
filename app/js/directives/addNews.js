function addNews($location, $compile, DatabaseManageData) {
  'ngInject';
        ...
        scope.addNews = (published) => {
          ...
          if(scope.newPost.postTitle.length >= 1 && scope.newPost.postTitle.length <= 80 && 
            ...
            scope.newPost.postTags.length >= 1 && scope.checkTeacher(scope.newPost.postTeacher)){
              ...
              let type = 'miniature';
              DatabaseManageData.uploadImage(scope.addPostMiniature, imageFolder, type).then(function(){
                scope.newPost.postPublished = published
                DatabaseManageData.addNews(scope.newPost).then(function(newsData){
